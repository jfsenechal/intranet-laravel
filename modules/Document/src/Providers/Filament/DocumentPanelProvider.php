...
namespace AcMarche\Document\Providers\Filament;
...
/**
 * Documents are readable without signing in. Writing stays behind the policies
 * and `ReadOnlyForGuestsTrait` on the resources.
 */
final class DocumentPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            // the document list, its search and the document pages.
            ->authMiddleware([]);
    }
}
