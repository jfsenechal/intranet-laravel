...
<div class="card-hover overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-gray-200 animate-fade-in-up"
     style="--delay: 0.15s">
        ...
        <div class="flex size-10 items-center justify-center rounded-xl bg-white/20 backdrop-blur">
            <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                ...
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M21 15.546c-.523 0-1.046.151-1.5.454a2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0 2.704 2.704 0 00-3 0 2.704 2.704 0 01-3 0A2.704 2.704 0 003 15.546V21h18v-5.454zM12 3v2m0 2a2 2 0 100-4 2 2 0 000 4zm0 0v6m-3 4h6"/>
            </svg>
        </div>
        <div class="min-w-0">
    ...
    <div class="p-4">
        @forelse ($todayBirthdays as $index => $employee)
            <div class="flex items-center gap-3 border-b border-gray-100 py-2 last:border-0 animate-fade-in-up"
                ...
                <div class="relative">
                    @if ($employee->photo && Storage::disk('public')->exists($employee->photo))
                        <img
                            ...
                            class="size-10 rounded-full object-cover ring-2 ring-amber-400"
                        />
                    @else
                        <img
