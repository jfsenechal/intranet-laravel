...
<table class="w-full border border-gray-300 border-collapse text-sm">
    <thead>
        <tr class="bg-gray-100">
            ...
            <th class="border border-gray-300 p-2 text-left">Voyage accompli</th>
            <th class="border border-gray-300 p-2 text-left">Motif de déplacement</th>
            <th class="border border-gray-300 p-2 text-left">Distance en Km</th>
            <th class="border border-gray-300 p-2 text-left">Frais de repas</th>
            <th class="border border-gray-300 p-2 text-left">Frais de train</th>
            <th class="border border-gray-300 p-2 text-left w-[11%]">Total</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr class="hover:bg-gray-50">
            ...
            <td class="border border-gray-300 p-2">{{ number_format($trip->meal_expense ?? 0, 2, ',', '.') }} €</td>
            <td class="border border-gray-300 p-2">{{ number_format($trip->train_expense ?? 0, 2, ',', '.') }} €</td>
            <td class="border border-gray-300 p-2">
        ...
        <tr class="bg-gray-100 font-semibold">
            ...
            <td class="border border-gray-300 p-2">{{ number_format($declarationSummary->mealExpense, 2, ',', '.') }} €</td>
            <td class="border border-gray-300 p-2">{{ number_format($declarationSummary->trainExpense, 2, ',', '.') }} €</td>
            <td class="border border-gray-300 p-2">{{ number_format($declarationSummary->totalMileageAllowance + $declarationSummary->totalExpense, 2, ',', '.') }} €</td>
        </tr>
        <tr class="hover:bg-gray-50">
            <td class="border border-gray-300 p-2">
