...
return new class extends Migration {
    ...
    {
        if (!Schema::connection('maria-mileage')->hasTable('rates')) {
        ...
        if (!Schema::connection('maria-mileage')->hasTable('budget_articles')) {
        ...
        if (!Schema::connection('maria-mileage')->hasTable('trips')) {
