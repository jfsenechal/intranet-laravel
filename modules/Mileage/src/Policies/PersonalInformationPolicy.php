...
final class PersonalInformationPolicy
{
     ...
     */
    public function restore(PersonalInformation $user, PersonalInformation $personalInformation): bool
    {
        return false;
    }
     ...
     */
    public function forceDelete(PersonalInformation $user, PersonalInformation $personalInformation): bool
    {
        return false;
    }
