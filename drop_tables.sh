...
DATABASES=("intranet" "actu" "document" "finance" "publication" "indicateur_ville" "grh_all" "pst" "mailinglist" "agent" "cpas_repas" "mediation" "invitation" "sanction" "telephone")
